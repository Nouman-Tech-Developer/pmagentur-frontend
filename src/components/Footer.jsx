    ...
    <>
        ...
        <div className="footer-container">
          <div className="footer-content">
            ...
            <div className="footer-column footer-column--main">
              ...
              <p className="footer-tagline">AI Automation for Companies</p>
              ...
              <div className="footer-contact">
                ...
                <div className="footer-contact-item">
                  ...
                  <span>Sample Street 123, 10115 Berlin</span>
                </div>
              </div>
            ...
            <div className="footer-column">
              ...
              <ul className="footer-links">
                <li><a href="#">AI Phone Assistant</a></li>
                <li><a href="#">Chatbots & Assistants</a></li>
          ...
          <div className="footer-bottom">
            <div className="footer-copyright">
              © {new Date().getFullYear()} Tolero GmbH. All rights reserved.
            </div>
      ...
      <style jsx="true">{`
        ...
        .site-footer {
          ...
          background: #000000;
          color: #FFFFFF;
          padding: 35px 100px 40px; /* 35px top, 100px sides, 40px bottom */
        ...
        @media only screen and (max-width: 1200px) {
          .site-footer {
            padding: 35px 60px 40px; /* Tablet: 35px top, 60px sides, 40px bottom */
          }
        }
        
        @media only screen and (max-width: 768px) {
          .site-footer {
            padding: 35px 40px 32px; /* Mobile: 35px top, 40px sides, 32px bottom */
          }
        }
        
        @media only screen and (max-width: 480px) {
          .site-footer {
            padding: 35px 24px 32px; /* Small mobile: 35px top, 24px sides, 32px bottom */
          }
        }
